...
# decorators : for restricting access to certain views, such as requiring user to be logged in or having certain permissions
# forms : for creating custom forms
# models : for creating custom models
...
# No custom views for password reset as Django by default will provide
